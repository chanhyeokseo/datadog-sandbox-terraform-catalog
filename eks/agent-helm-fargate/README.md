# Datadog Agent - Helm (Fargate)

Deploys the Datadog Agent for EKS Fargate using the Helm chart with Admission Controller sidecar injection.
...
- `agents` (DaemonSet) is disabled — Fargate does not support DaemonSets
